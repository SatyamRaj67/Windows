!(function (r) {
  ...
  function (t, n, e) {
      ...
      return (
        ...
        (t =
          0.04045 < (t /= 255)
            ...
            : t / 12.92),
        (e = 0.04045 < e ? Math.pow((e + 0.005) / 1.055, 2.4) : e / 12.92),
        (r = 0.04045 < r ? Math.pow((r + 0.005) / 1.055, 2.4) : r / 12.92),
        [
    ...
    function i(t, e, r) {
      return (
        ...
        (r /= 108.883),
        (t =
          0.008856 < (t /= 95.047) ? Math.pow(t, 1 / 3) : 7.787 * t + 16 / 116),
        [
          116 * (e = 0.008856 < e ? Math.pow(e, 1 / 3) : 7.787 * e + 16 / 116) -
            16,
          500 * (t - e),
          200 *
            (e -
    ...
    function a(t, e) {
      var r = t[0],
        ...
        e =
          Math.sqrt(e) > Math.sqrt(Math.abs(r)) + Math.sqrt(Math.abs(a))
            ? Math.sqrt(e * e - r * r - a * a)
            : 0;
      return (
        (r /= 1),
        (a /= 1 + 0.045 * o),
        (e /= 1 + 0.015 * o),
        Math.sqrt(r * r + a * a + e * e)
      );
    }
    function s(t, e) {
    ...
    Object.defineProperty(n, "__esModule", { value: !0 }),
      ...
      (n.defer = function () {
        ...
        return { resolve: r, reject: n, promise: t };
      }),
      (n.hexToRgb = r),
      (n.rgbToHex = function (t, e, r) {
        return (
      ...
      (n.deltaE94 = a),
      (n.rgbDiff = s),
      (n.hexDiff = function (t, e) {
        return s(r(t), r(e));
      }),
      (n.getColorDiffStatus = function (t) {
        return t < n.DELTAE94_DIFF_STATUS.NA
          ? "N/A"
          : t <= n.DELTAE94_DIFF_STATUS.PERFECT
          ? "Perfect"
          : t <= n.DELTAE94_DIFF_STATUS.CLOSE
          ? "Close"
          : t <= n.DELTAE94_DIFF_STATUS.GOOD
          ? "Good"
          : t < n.DELTAE94_DIFF_STATUS.SIMILAR
          ? "Similar"
          : "Wrong";
      }),
  ...
  function (t, e, r) {
    ...
    t.exports = function (t, e) {
      return (
        (t = t.__data__),
        n(e) ? t["string" == typeof e ? "string" : "hash"] : t.map
      );
    };
  },
  function (t, e, r) {
  ...
  function (t, e, r) {
    "use strict";
    Object.defineProperty(e, "__esModule", { value: !0 }), (e.Swatch = void 0);
    var n = r(9),
      o = r(69),
      r =
        ((i.applyFilter = function (t, n) {
  ...
  function (t, e, r) {
    var o = r(32),
      i = r(11);
    t.exports = function (t, e) {
      for (var r = 0, n = (e = o(e, t)).length; null != t && r < n; )
        t = t[i(e[r++])];
  ...
  function (t, e, r) {
    ...
    var n =
      ...
      i =
        ...
        function (t) {
          ...
          if (null != t)
            for (var r in t)
              "default" !== r && Object.hasOwnProperty.call(t, r) && n(e, t, r);
          return o(e, t), e;
        },
      u =
    ...
    function p(t, e) {
      (this._src = t),
        (this.opts = h({}, e, p.DefaultOpts)),
        (this.opts.combinedFilter = l.combineFilters(this.opts.filters));
    }
    e.default = f;
  },
  function (t, e) {
    ...
    t.exports = function (t, e, r, n, o, i) {
      ...
      for (i.set(t, e), i.set(e, t); ++f < a; ) {
        var p,
          ...
          b = e[f];
        if (
          (n && (p = u ? n(b, v, f, e, t, i) : n(v, b, f, t, e, i)),
          void 0 !== p)
        ) {
          if (p) continue;
          l = !1;
  ...
  function (t, e, r) {
    ...
    (N[R] =
      ...
      N["[object Uint32Array]"] =
        !0),
      (N["[object Error]"] = N[U] = N["[object WeakMap]"] = !1),
      (t.exports = function r(n, o, i, t, e, u) {
        var a,
          s = o & k,
          c = o & V,
          f = o & z;
  ...
  function (t, e, r) {
    ...
    t.exports = function (i, u, a) {
      return (
        (u = c(void 0 === u ? i.length - 1 : u, 0)),
        function () {
          for (
            var t = arguments, e = -1, r = c(t.length - u, 0), n = Array(r);
            ++e < r;
  ...
  function (t, e, r) {
    ...
    t.exports = function (i, u) {
      return function (t, e) {
        ...
        if (!a(t)) return i(t, e);
        for (
          var r = t.length, n = u ? r : -1, o = Object(t);
          (u ? n-- : ++n < r) && !1 !== e(o[n], n, o);
  ...
  function (t, e, r) {
    ...
    t.exports = function (t, e, r, n, o, i) {
      ...
      if (c && !f)
        return (
          (i = i || new l()),
          u || y(t) ? h(t, e, r, n, o, i) : p(t, e, s, r, n, o, i)
        );
      if (!(1 & r)) {
        (f = f && j.call(t, "__wrapped__")),
          (a = a && j.call(e, "__wrapped__"));
        if (f || a)
          return o(
            f ? t.value() : t,
            a ? e.value() : e,
    ...
    t.exports = function (t, e, r, n, o, i, u) {
      switch (r) {
        ...
        case "[object ArrayBuffer]":
          return t.byteLength == e.byteLength && i(new s(t), new s(e))
            ? !0
            : !1;
        case "[object Boolean]":
        case "[object Date]":
    ...
    t.exports = function (t, e, r, n, o, i) {
      ...
      for (var v = u; ++c < s; ) {
        var b,
          ...
          g = e[f];
        if (
          (n && (b = u ? n(g, d, f, e, t, i) : n(d, g, f, t, e, i)),
          !(void 0 === b ? d === g || o(d, g, r, n, i) : b))
        ) {
          p = !1;
          break;
        }
  ...
  function (t, e, r) {
    ...
    t.exports = function (t, e, r) {
      ...
      return i || ++n != o
        ? i
        : !!(o = null == t ? 0 : t.length) && l(o) && f(u, o) && (c(t) || s(t));
    };
  },
  function (t, e, r) {
    var n = r(138),
  ...
  function (t, e, r) {
    ...
    var o = n(r(40)),
      i = r(141),
      r =
        ((u.prototype.maxColorCount = function (t) {
    ...
    function u(t, e) {
      void 0 === e && (e = {}),
        (this._src = t),
        (this._opts = e),
        (this._opts.filters = i(o.default.DefaultOpts.filters));
    }
    e.default = r;
  },
  function (t, e, r) {
  ...
  function (t, e, r) {
    ...
    e.default = function (t, e) {
      if (0 === t.length || e.colorCount < 2 || 256 < e.colorCount)
  ...
  function (t, e, r) {
    ...
    var j = r(9),
      r =
        ...
        (d.prototype.volume = function () {
          ...
          return (
            this._volume < 0 &&
              ((t = (i = this.dimension).r1),
              (e = i.r2),
              (r = i.g1),
              (n = i.g2),
              (o = i.b1),
              (i = i.b2),
              (this._volume = (e - t + 1) * (n - r + 1) * (i - o + 1))),
            this._volume
          );
        }),
        ...
        (d.prototype.split = function () {
          ...
          for (
            var g = -1, y = new Uint32Array(h.length), m = 0;
            m < h.length;
            m++
          ) {
            var _ = h[m];
          ...
          return (function (t) {
            for (
              var e = t + "1",
                ...
                o =
                  a <= (t = o - g)
                    ? ((o = Math.min(o - 1, ~~(g + t / 2))), Math.max(0, o))
                    : ((o = Math.max(n, ~~(g - 1 - a / 2))),
                      Math.min(x.dimension[r], o));
              !h[o];
    ...
    function d(t, e, r, n, o, i, u) {
      (this._volume = -1),
        (this._count = -1),
        (this.dimension = { r1: t, r2: e, g1: r, g2: n, b1: o, b2: i }),
        (this.hist = u);
    }
    e.default = r;
  },
        ...
        t.forEach(function (t) {
          ...
          l <= n &&
            ...
            (r = i).Vibrant !== e &&
              ...
              r.DarkMuted !== e &&
              r.LightMuted !== e) &&
            ((o = g(n, f, o, a, t.getPopulation(), u, p)),
            (null === v || b < o) && ((v = t), (b = o)));
        }),
        v
      );
    ...
    e.default = function (t, e) {
      ...
      var r,
        ...
        h =
          (((o = {}).Vibrant = y(
            ...
            (n = t),
            (t = h),
            (h = e).targetNormalLuma,
            h.minNormalLuma,
            h.maxNormalLuma,
            h.targetVibrantSaturation,
            h.minVibrantSaturation,
            1,
            h
          )),
          (o.LightVibrant = y(
          ...
          (o.Muted = y(
            ...
            h.minNormalLuma,
            h.maxNormalLuma,
            h.targetMutesSaturation,
            0,
            h.maxMutesSaturation,
            h
          )),
          (o.LightMuted = y(
            o,
      ...
      return (
        ...
        null === (e = h).Vibrant &&
          ...
          (null === e.DarkVibrant &&
            null !== e.DarkMuted &&
            ((c = (l = e.DarkMuted.getHsl())[0]),
            (f = l[1]),
            (l = l[2]),
            (l = o.targetDarkLuma),
            (e.DarkVibrant = new p.Swatch(v.hslToRgb(c, f, l), 0))),
          null === e.LightVibrant &&
            null !== e.LightMuted &&
            ((c = (i = e.LightMuted.getHsl())[0]),
            (f = i[1]),
            (l = i[2]),
            (l = o.targetDarkLuma),
            (e.DarkVibrant = new p.Swatch(v.hslToRgb(c, f, l), 0)))),
        null === e.Vibrant && null !== e.DarkVibrant
          ? ((c = (i = e.DarkVibrant.getHsl())[0]),
            (f = i[1]),
            (l = i[2]),
            (l = o.targetNormalLuma),
            (e.Vibrant = new p.Swatch(v.hslToRgb(c, f, l), 0)))
          : null === e.Vibrant &&
            null !== e.LightVibrant &&
            ((c = (u = e.LightVibrant.getHsl())[0]),
            (f = u[1]),
            (l = u[2]),
            (l = o.targetNormalLuma),
            (e.Vibrant = new p.Swatch(v.hslToRgb(c, f, l), 0))),
        ...
        null === e.LightVibrant &&
          null !== e.Vibrant &&
          ((c = (a = e.Vibrant.getHsl())[0]),
          (f = a[1]),
          (l = a[2]),
          (l = o.targetLightLuma),
          (e.LightVibrant = new p.Swatch(v.hslToRgb(c, f, l), 0))),
        null === e.Muted &&
          null !== e.Vibrant &&
          ((c = (a = e.Vibrant.getHsl())[0]),
          (f = a[1]),
          (l = a[2]),
          (l = o.targetMutesSaturation),
          (e.Muted = new p.Swatch(v.hslToRgb(c, f, l), 0))),
        null === e.DarkMuted &&
          null !== e.DarkVibrant &&
          ((c = (s = e.DarkVibrant.getHsl())[0]),
          (f = s[1]),
          (l = s[2]),
          (l = o.targetMutesSaturation),
          (e.DarkMuted = new p.Swatch(v.hslToRgb(c, f, l), 0))),
        null === e.LightMuted &&
          null !== e.LightVibrant &&
          ((c = (s = e.LightVibrant.getHsl())[0]),
          (f = s[1]),
          (l = s[2]),
          (l = o.targetMutesSaturation),
          (e.LightMuted = new p.Swatch(v.hslToRgb(c, f, l), 0))),
        h
      );
    };
  },
  ...
  function (t, e, r) {
    ...
    t.exports = function (t, e, r) {
      ...
      var n = typeof e;
      return (
        !!("number" == n ? i(r) && u(e, r.length) : "string" == n && e in r) &&
        o(r[e], t)
      );
    };
  },
  ...
  function (t, e, r) {
    ...
    var f,
      o =
        ((f = s.ImageBase),
        o(l, f),
        (l.prototype._initCanvas = function () {
          var t = this.image,
  ...
  function (t, e, r) {
    ...
    Object.defineProperty(e, "__esModule", { value: !0 }),
      (e.ImageBase = void 0);
    var n =
      ((o.prototype.scaleDown = function (t) {
        var e,
          r = this.getWidth(),
          n = this.getHeight(),
          o = 1;
        0 < t.maxDimension
          ? (e = Math.max(r, n)) > t.maxDimension && (o = t.maxDimension / e)
          : (o = 1 / t.quality),
          o < 1 && this.resize(r * o, n * o, o);
      }),
      (o.prototype.applyFilter = function (t) {
        var e = this.getImageData();
        if ("function" == typeof t)
          for (var r, n = e.data, o = n.length / 4, i = 0; i < o; i++)
            t(n[0 + (r = 4 * i)], n[1 + r], n[2 + r], n[3 + r]) ||
              (n[3 + r] = 0);
  ...
  function (t, e, r) {
    ...
    (x.prototype.parse = function (t, e, r) {
      ...
      if (
        ...
        -1 !== (x = -1 === s ? i.lastIndexOf("@") : i.lastIndexOf("@", s)) &&
          ((j = i.slice(0, x)),
          (i = i.slice(x + 1)),
        ...
        if (!l)
          for (
            var h = this.hostname.split(/\./), c = 0, p = h.length;
            c < p;
            c++
          ) {
            var v = h[c];
            if (v && !v.match(L)) {
              for (var b = "", d = 0, g = v.length; d < g; d++)
                127 < v.charCodeAt(d) ? (b += "x") : (b += v[d]);
              if (!b.match(L)) {
                var y = h.slice(0, c),
                  m = h.slice(c + 1),
                  _ = v.match(F);
                _ && (y.push(_[1]), m.unshift(_[2])),
                  m.length && (i = "/" + m.join(".") + i),
        ...
        255 < this.hostname.length
          ...
          l || (this.hostname = A.toASCII(this.hostname));
      ...
      if (!E[S])
        for (c = 0, p = P.length; c < p; c++) {
          var w,
            O = P[c];
          -1 !== i.indexOf(O) &&
            ((w = encodeURIComponent(O)) === O && (w = escape(O)),
            (i = i.split(O).join(w)));
        }
      l = i.indexOf("#");
      -1 !== l && ((this.hash = i.substr(l)), (i = i.slice(0, l)));
      var S,
        l = i.indexOf("?");
      return (
        -1 !== l
          ? ((this.search = i.substr(l)),
            (this.query = i.substr(l + 1)),
            e && (this.query = z.parse(this.query)),
            (i = i.slice(0, l)))
          : e && ((this.search = ""), (this.query = {})),
        i && (this.pathname = i),
      ...
      (x.prototype.format = function () {
        ...
        this.host
          ...
          this.query &&
            M.isObject(this.query) &&
            Object.keys(this.query).length &&
            (i = z.stringify(this.query));
        i = this.search || (i && "?" + i) || "";
        return (
          e && ":" !== e.substr(-1) && (e += ":"),
      ...
      (x.prototype.resolveObject = function (t) {
        ...
        if (t.protocol && t.protocol !== e.protocol) {
          ...
          if (((e.protocol = t.protocol), t.host || k[t.protocol]))
          ...
          return (
            ...
            (e.port = t.port),
            (e.pathname || e.search) &&
              ((v = e.pathname || ""), (b = e.search || ""), (e.path = v + b)),
        ...
        if (
          ...
          return (
            ...
            (e.search = t.search),
            (e.query = t.query),
            (M.isNull(e.pathname) && M.isNull(e.search)) ||
        ...
        for (
          ...
          "." === (g = d[m])
            ...
            ? (d.splice(m, 1), y++)
            : y && (d.splice(m, 1), y--);
        if (!v && !b) for (; y--; ) d.unshift("..");
        !v || "" === d[0] || (d[0] && "/" === d[0].charAt(0)) || d.unshift(""),
          p && "/" !== d.join("/").substr(-1) && d.push("");
        var _,
          p = "" === d[0] || (d[0] && "/" === d[0].charAt(0));
        return (
          h &&
            ((e.hostname = e.host = !p && d.length ? d.shift() : ""),
            (_ = !!(e.host && 0 < e.host.indexOf("@")) && e.host.split("@")) &&
              ((e.auth = _.shift()), (e.host = e.hostname = _.shift()))),
          (v = v || (e.host && d.length)) && !p && d.unshift(""),
          d.length
            ? (e.pathname = d.join("/"))
      ...
      /*! https://mths.be/punycode v1.3.2 by @mathias */ !(function () {
        ...
        function f(t, e) {
          ...
          return (
            ...
            n + c((t = t.replace(u, ".")).split("."), e).join(".")
          );
        }
        function M(t) {
        ...
        function l(t) {
          var e,
            ...
            h = x,
            p = t.lastIndexOf(w);
          for (p < 0 && (p = 0), r = 0; r < p; ++r)
            128 <= t.charCodeAt(r) && A("not-basic"), s.push(t.charCodeAt(r));
          for (n = 0 < p ? p + 1 : 0; n < c; ) {
            for (
              o = f, i = 1, u = y;
              c <= n && A("invalid-input"),
                ...
                (y <=
                  ...
                  A("overflow"),
                (f += a * i),
                !(a < (a = u <= h ? m : h + _ <= u ? _ : u - h));
              u += y
            )
              i > O(g / (a = y - a)) && A("overflow"), (i *= a);
            (h = T(f - o, (e = s.length + 1), 0 == o)),
              O(f / e) > g - l && A("overflow"),
              (l += O(f / e)),
              (f %= e),
              s.splice(f++, 0, l);
          }
        ...
        "object" == typeof r
          ? a(s(r), function (t) {
              ...
              return u(r[t])
                ...
                : e + encodeURIComponent(i(r[t]));
            }).join(n)
          : t
          ? encodeURIComponent(i(t)) + o + encodeURIComponent(i(r))
          : ""
      );
    };
    var u =
  ...
  function (t, e, r) {
    ...
    Object.defineProperty(e, "__esModule", { value: !0 });
    r = r(68);
    ("object" == typeof window && window instanceof Window
      ? window
      : t.exports
    ).Vibrant = r;
  },
